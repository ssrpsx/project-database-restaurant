...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-100 fixed top-0 w-full z-50 shadow-xl">
      {showPopup && (
        <div className="fixed inset-0 bg-black/70 bg-opacity-40 flex items-start justify-center pt-46 z-10">
          ...
          <div className="bg-white w-11/12 max-w-md rounded-xl shadow-xl p-6 animate-fadeIn">
            ...
            <p className="text-gray-800 text-center mb-6 wrap-break-word">
              {data?.DESCRIPTION}
            </p>
      ...
      <div className="container mx-auto flex justify-between items-center p-4">
        <div className="text-xl font-bold text-gray-800">{data?.NAME || "Loading..."}</div>
  ...
  `}
        >
          <a
            href={`/${table_number}/`}
            className="block px-4 py-2 text-gray-800 hover:underline lg:inline-block ml-2"
